    ...
    <div>
      ...
      <v-row>
        <v-col>
          ...
          <v-dialog v-model="dialogAddTail" width="600px" persistent>
            <v-card class="pa-4" style="margin-top: 40px">
              <v-row>
                <v-col cols="11">
                  <v-card-title class="text-h5 text-center" style="color: #0b5de1"
                    >ADD TAIL SECTION</v-card-title
                  >
                </v-col>
                <v-col cols="1">
                  <v-icon @click="dialogAddTail = false">mdi-close</v-icon>
                </v-col>
              </v-row>
